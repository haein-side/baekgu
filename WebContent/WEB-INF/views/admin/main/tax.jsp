   ...
   <td width='100%'>
    <table cellpadding='0' cellspacing='0' width='700'>
     ...
     <tr>
      ...
      <td class='border_up' align='center' width='20'>0</td>
      <td class='border_up' align='center' width='20'>0</td>
      <td class='border_up' align='center' width='20'>0</td>
      <td class='border_up' align='center' width='20'>0</td>
      <td class='border_up' align='center' width='20'>${ taxprices["1000000"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["100000"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["10000"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["1000"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["100"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["10"]}</td>
      <td class='border_up' align='center' width='20'>${ taxprices["1"]}</td>
