...
<body>
	...
	<div class="container">
		<div class="wrapper">
        	...
        	<div>
		    	<label class="text-label"><b>휴대폰 번호 (아이디로 사용됩니다.)</b></label>
		    	...
		    	<small id="passwordHelp" class="form-text text-muted" style="margin-bottom: 10px">영어와 숫자를 사용하여 8자리 이상 입력하세요.<br>(대문자, 소문자 사용에 주의하세요.)</small><br><br><br>
