...
<body class="bg-light">
	...
	<form>
		<div class="container"
			style="z-index: 1; margin-top: 15%; margin: auto;">
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="mobile"
							placeholder="(예 : 01012345678)" required> <small
							id="passwordHelp" class="form-text text-muted">특수문자(-) 없이
							숫자로만 10자리 혹은 11자리를 입력하세요.</small>
					</div>
					<br>
					<div class="form-group">
						<label for="password" class="basiclabel">비밀번호</label> <input
							type="password" class="form-control" id="password"
							placeholder="(예 : hgd610405)" aria-describedby="" required>
					...
					<br>
					<div class="form-group">
						<label for="name" class="basiclabel">이름</label> <input type="text"
							class="form-control" id="name" placeholder="(예 : 홍길동)" required>
						<small id="passwordHelp" class="form-text text-muted">이름을
							입력해주세요.</small>
					</div>
					<br>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4 mb-3">
					<label for="birthmonth" class="basiclabel">태어난 달</label><br> <input
						type="number" class="birthinfo" id="birthmonth" min="1" max="12"
						step="1" value="1" placeholder="(예 : 08)" style="width: 150px"
						required> <label>월</label><br> <small
						class="form-text text-muted">(예 : 08)</small>
				</div>
				<div class="col-md-4 mb-3">
					<label for="birthday" class="basiclabel">태어난 날</label><br> <input
						type="number" class="birthinfo" id="birthday" min="1" max="31"
						step="1" value="1" placeholder="(예 : 08)" style="width: 150px"
						required> <label>일</label><br> <small
						class="form-text text-muted">(예 : 31)</small>
				</div>
			</div>
			<br>
			...
			<div class="form-group">
				...
				<br> <input type="radio" id="gender" name="gender"
					class="genderset" value="male" style="font-size: 30px;"><label
					class="genderlabel">남</label> <input type="radio" id="gender"
					name="gender" class="genderset" value="famale"><label
					class="genderlabel">여</label>
			</div>
			<br>

			<div class="form-group">
				<label for="address" class="basiclabel">주소</label> <input
					type="text" class="form-control" id="address"
					placeholder="(예 : 서울시 서초구 서초동 1310-15)" required> <small
					id="address" class="form-text text-muted">시, 구, 동까지 입력해주세요.</small><br>
				<input type="text" class="form-control" id="address"
					placeholder="(예 : 서초빌라 302호)"> <small id="address"
					class="form-text text-muted">세부 주소(번지, 건물명, 호수)를 입력해주세요.</small>
			</div>
			<br>
			...
			<div>
				...
				<div class="form-group">
					...
					<div class="user_join_agree agrSelect">
						<input type="checkbox" name="Agree1" id="agreeChk_0"
							class="agrSelect" value="on"><label for="agreeChk_0"
							style="font-size: 16px;">[선택] 이메일/SMS 수신 동의</label>&nbsp;&nbsp;<a
							href="#" style="font-size: 16px;">내용보기</a>
					</div>
