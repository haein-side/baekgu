...
/**
 * Servlet implementation class AdminPostingListServlet
 */
@WebServlet("/admin/posting")
public class AdminPostingListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int total = postList.selectTotalPosting();
		...
		List<PostDTO> postingList = postList.postingList(pageInfo);
		
		String path = "";
		if(postingList != null) {
			path = "/WEB-INF/views/admin/main/Post.jsp";
			request.setAttribute("postList", postingList);
