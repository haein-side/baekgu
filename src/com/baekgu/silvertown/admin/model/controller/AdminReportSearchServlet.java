...
public class AdminReportSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("servlet condition : " + condition);
		//사용자가 입력한 값이다
		...
		int count = reportService.SearhCount(condition, value);
		...
		List<BlockDTO> reportList = reportService.selectSearchReport(condition, value, pageInfo);
