package com.baekgu.silvertown.common.paging;
...
public class PageNation {
	...
	public static PageInfoDTO getPageInfo(int pageNo, int selection, int limit, int buttonAmount, String pageCategory) {
		...
		/* 총 페이지 수 계산*/  
		//maxPage = (int)((double)totalCount/ limit + 0.9);
		maxPage =  (int) Math.ceil((double)selection/limit);
		...
		PageInfoDTO pageInfo = new PageInfoDTO(pageNo,selection,limit,buttonAmount,maxPage,startPage,endPage,startRow,endRow, pageCategory);
